...
**Durée cible : 10 minutes.** Support : `maquette_tefd.html` projetée plein écran (Chrome ou Edge, mode présentation). Rien à installer. Aucun appel facturé pendant la démo : le modèle est **tout-lien** (les boutons ouvrent Google Maps gratuitement, sans clé).
...
| **5:30–6:30** | « Et je règle la distance comme au comptoir. » | Fais glisser le **curseur "à pied"** (ex. 10 min). Les temps de marche sont **précalculés** (zéro calcul à l'écran). | Paramètre temps/distance concret, tri instantané (zéro appel runtime). |
